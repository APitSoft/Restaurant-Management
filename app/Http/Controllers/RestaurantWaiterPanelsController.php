...
class RestaurantWaiterPanelsController extends Controller
{
    ...
    public function index()
    {
        ...
        if ($shift != false) {
            ...
            // return count($t);
            return view('pages.restaurant.waiterPanels.waiterPos', compact('shift', 'countries', 'restaurant', 'notifications', 'categories', 'food_menus', 'floors', 'waiters', 'customers', 'new_orders','subcategories'));
        }
