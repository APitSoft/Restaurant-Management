...
Route::group(['middleware' => ['XSS']], function () {
    ...
    Route::group(['prefix' => 'api'], function () {
        Route::get('/buissiness-info/{key}', 'RestaurantAPIsController@alldata');
        Route::get('/customer_online_orders-info/{key}', 'RestaurantAPIsController@customerOnlineOrders');
        Route::get('/food_menus-info/{key}', 'RestaurantAPIsController@foodMenus');
    ...
    //Recall Screen
    Route::get('/recall_screen', 'RestaurantSaleController@recallscreen')->name('recall_screen');
    Route::get('/recall_supplier/{id}','RestaurantSaleController@recallsupplier')->name('recall_supplier');
    Route::get('/assign_server','RestaurantSaleController@assignserver')->name('assign_server');
    Route::get('/change_waiter/{id}','RestaurantSaleController@changewaiter')->name('change_waiter');
    Route::post('/update_waiter/{sales}','RestaurantSaleController@updatewaiter')->name('update_waiter');
    Route::get('/add_tips/{id}','RestaurantSaleController@addtips')->name('add_tips');
    Route::post('/assign_tips/','RestaurantSaleController@assigntips')->name('assign_tips');
...
//------------------STAFF-------------------//
    ...
    Route::group(['prefix' => 'restaurant'], function () {
        ...
        //-----------serve Group-------------
        Route::get('/serve-Group/','RestaurantHomeController@serveGroup')->name('serve-Group');
        Route::post('/Add-serve-Group/','RestaurantHomeController@AddserveGroup')->name('Add-serve-Group');
        Route::get('/View-serve-Group/','RestaurantHomeController@ViewserveGroup')->name('View-serve-Group');
        Route::get('/Serve-Group/{id}','RestaurantHomeController@EditServeGroup')->name('Serve-Group');
        Route::post('/update-Serve-Group/','RestaurantHomeController@updateServeGroup')->name('update-Serve-Group');
        Route::get('/Delete-Serve-Group/{id}','RestaurantHomeController@DeleteServeGroup')->name('Delete-Serve-Group');
        Route::get('/Add-Waiter-Group/{id}','RestaurantHomeController@AddWaiterGroup')->name('Add-Waiter-Group');
        Route::post('/Add-Waiter-Group-new/','RestaurantHomeController@AddWaiterGroupnew')->name('Add-Waiter-Group-new');
        Route::get('/Waiter_All_del/{id}','RestaurantHomeController@DeleteWaiterall')->name('Waiter_All_del');
      ...
      //---------- Payment Active-------------
        ...
        Route::group(['prefix' => 'settings'], function () {
            ...
            //=======================Api=================//
            Route::get('add-api', 'RestaurantSettingsController@api')->name('restaurant.api');
            Route::get('generate', 'RestaurantSettingsController@api')->name('generate');
            Route::post('update-api', 'RestaurantSettingsController@updateapi')->name('update-api');
        ...
        Route::group(['prefix' => 'sale'], function () {
            ...
            //Customer Payment
            Route::get('/customer_de','RestaurantFoodMenuCategoriesController@customer_due')->name('customer_due');
            Route::post('/add_customer_payment','RestaurantFoodMenuCategoriesController@add_customer_payment')->name('add_customer_payment');
            Route::get('/customer_payment/{id}','RestaurantFoodMenuCategoriesController@customer_payment')->name('customer_payment');
            Route::post('/customer_final_payment','RestaurantFoodMenuCategoriesController@customer_final_payment')->name('customer_final_payment');
           ...
           // Route::get('/Waste-Report', 'RestaurantFloorController@DetailsfoodsaleReport')->name('Details-foodsaleReport');
            ...
            Route::get('/seal', 'RestaurantSaleController@seal')->name('seal');



            Route::post('/get_all_information_of_a_sale_ajax', 'RestaurantSaleController@getInformationOfSaleByAjax');
            Route::get('/test', 'RestaurantSaleController@test')->name('test');
        ...
        Route::group(['prefix' => 'kitchen'], function () {
            ...
            Route::get('/text', 'RestaurantKitchenPanelsController@text')->name('text');
           ...
           // Route::get('/text', 'RestaurantKitchenPanelsController@text')->name('text');
            ...
            //-----------Add-panels
//            Route::get('/Add-panels', 'RestaurantKitchenPanelsController@Addpanels')->name('Add-panels');
//            Route::post('/panels-add', 'RestaurantKitchenPanelsController@panelsadd')->name('panels-add');
//            Route::get('/edit-panels/{id}', 'RestaurantKitchenPanelsController@editpanels')->name('edit-panels');
//            Route::post('/panels-up', 'RestaurantKitchenPanelsController@panelsup')->name('panels-up');
//            Route::get('/deleted-panels/{id}', 'RestaurantKitchenPanelsController@deletedpanels')->name('deleted-panels');
        });
    ...
    //pos resurvation
    Route::get('/search_reservation/{id}', 'RestaurantReservationController@searchreservation')->name('search_reservation');
