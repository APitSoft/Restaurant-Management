                ...
                @if($usermanagement)
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            @endif
                                @if($status['staff_list'])
                                    <li><a href="{{route('serve-Group')}}"><i class="fa fa-angle-double-right"></i>Add Serve Group
                                            </a></li>
                                @endif
                                @if($status['staff_list'])
                                    <li><a href="{{route('View-serve-Group')}}"><i class="fa fa-angle-double-right"></i>View Serve Group
                                            List</a></li>
                                @endif
                        </ul>
                    </li>
                ...
                @if($food_menu)
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            @if($status['add_food_menu'])
                                <li><a href="{{route('food-menu.create')}}"><i
                                            class="fa fa-angle-double-right"></i>Add
                                        Food Menu</a></li>
                            @endif
...
{{--                @endif--}}
                ...
                <li class="treeview">
                    <a href="#">
                        <i data-feather="clock"></i> <span>Kitchen Panels</span>
                        <span class="pull-right-container">
                            <i class="fa fa-angle-left pull-right"></i>
                        </span>
                    </a>
                    <ul class="treeview-menu">
{{--                        <li><a href="{{route('Add-panels')}}"><i class="fa fa-angle-double-right"></i>Add Kitchen Panels</a></li>--}}
{{--                       <li><a href="{{route('panels.all')}}"><i class="fa fa-angle-double-right"></i>Kitchen Panels Show</a></li>--}}
                        <li><a href="{{route('kitchen-panels.index')}}"><i class="fa fa-angle-double-right"></i>Kitchen Panels</a>
                        <li><a href="{{route('kitchen-panels.create')}}"><i class="fa fa-angle-double-right"></i>Add Kitchen Panels</a>
                    </ul>
                </li>
                ...
                @if($payment)
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            @endif
                            @if($status['add_customer_payment'])
                                    <li><a href="{{route('customer_due')}}"><i class="fa fa-angle-double-right"></i>Add Customer Payment</a></li>
                            @endif
                            @if($status['list_customer_payment'])
...
{{--                <li>--}}
{{--                    <a href="{{route('recall_screen')}}">--}}
{{--                        <i data-feather="monitor"></i> <span>Recall Screen</span>--}}
{{--                    </a>--}}
{{--                </li>--}}
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
{{--                        @if($status['reservation'])--}}
                            <li><a href="{{route('recall_screen')}}"><i
                                        class="fa fa-angle-double-right"></i>Recall Transition</a></li>
{{--                        @endif--}}
{{--                        @if($status['gift_card_list'])--}}
                            <li><a href="{{route('assign_server')}}"><i class="fa fa-angle-double-right"></i>Re Assign
                                    Server</a></li>
{{--                        @endif--}}
...
{{--                                @endif--}}
                                ...
                                @if($status['profile_update'])
                                    <li><a href="{{route('restaurant.api')}}"><i class="fa fa-angle-double-right"></i>API</a></li>
                                @endif
                        </ul>
                    </li>
                @endif
